...
<html lang="pt-br" itemscope itemtype="https://schema.org/Article">
    ...
    <body>
            ...
            <div class="more_and_gallery">
                ...
                <nav class="gallery container">
                    ...
                    for ($i = 8; $i < 12; $i++):
                        ...
                        echo "<a href='uploads/{$image}.jpg' rel='shadowbox[gb]'><img src='tim.php?src=uploads/{$image}.jpg&w=360&h=180' alt='Galeria' title='Galeria'/></a>";
                    endfor;
                    ?>
        ...
        <script src="_cdn/wsrwd.js"></script>
    </body>
</html>